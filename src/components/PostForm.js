...
function PostForm({user}) {
    ...
    function send_post(event) {
        ...
        // Get inputs
        const userInput = document.getElementById("user-header-input");
        const textInput = document.getElementById("text-header-input");
        const fileInput = document.getElementById("image-header-input");
                        ...
                        <div className="post-form-div">
                            <form id="simple-post-form">
                                ...
                                <div className="post-form-footer">
                                    <label htmlFor="image-header-input" id="file-input">
                                        <div>
                                    ...
                                    <input onChange={loadImg} id="image-header-input" type="file" accept=".jpg, .jpeg, .png"/>
